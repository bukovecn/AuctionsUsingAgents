...
public class Auctioner extends Agent{
    ...
    protected void setup() {
        System.out.println("Aukcionar pokreæe aukciju!");

        Object[] args = getArguments();
        if (args != null && args.length > 0) {
            nazivPredmeta = (String) args[0];
            cijenaPredmeta = Integer.parseInt((String) args[1]);
            System.out.println("Prodaje se \"" + nazivPredmeta + "\" s poèetnom cijenom " + cijenaPredmeta + " kn");
            System.out.println("Možete dati svoje ponude!");
                ...
                public void action() {
                    ...
                    try {
                        ...
                        for (int i = 0; i < result.length; i++) {
                            //System.out.println("Naðen kupac: " + result[i].getName());
        ...
        public void action() {
            switch (step) {
                ...
                case 2:
                    ...
                    if (maxKupac != null) {
                        System.out.println("Najviša ponuðena cijena: " + maxPonuda + " kn od " + maxKupac.getName());
                    } else {
                        System.out.println("Primljene samo neodgovarajuæe ponude!");
                    }
